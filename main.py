"""Main entry point for NATS Stream Processor service."""
...
from src.service import StreamProcessorService


def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="NATS Stream Processor Service")
...
async def run_service() -> None:
    """Construct and run the StreamProcessorService instance until termination."""
    svc = StreamProcessorService()
    await svc.run()
